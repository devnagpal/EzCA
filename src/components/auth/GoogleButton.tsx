...
export function GoogleButton({ label = "Continue with Google" }: GoogleButtonProps) {
    ...
    const handleClick = async () => {
        ...
        // On success, OAuth redirect happens — no need to set loading false
    };
        ...
        <div className="flex flex-col gap-2">
            <motion.button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl
                           bg-white/[0.04] border border-white/[0.1] text-sm font-medium
                           text-foreground hover:bg-white/[0.08] hover:border-white/[0.15]
